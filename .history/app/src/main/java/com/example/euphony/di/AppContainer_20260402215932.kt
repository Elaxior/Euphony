...
object AppContainer {
    ...
    fun provideAddToQueueUseCase(): AddToQueueUseCase {
        return AddToQueueUseCase(queueRepository)
    }

    fun provideAddToQueueNextUseCase(): AddToQueueNextUseCase {
        return AddToQueueNextUseCase(queueRepository)
    }
    ...
    fun provideSearchViewModelFactory(): SearchViewModelFactory {
        return SearchViewModelFactory(
            ...
            provideAddToQueueUseCase(),
            provideAddToQueueNextUseCase()
        )
    }
