...
internal fun typographyForPreset(preset: EuphonyThemePreset): Typography {
    return when (preset) {
        ...
        EuphonyThemePreset.SUNSET -> baseTypography(
        ...
        EuphonyThemePreset.FOREST -> baseTypography(
        ...
        EuphonyThemePreset.MONO -> baseTypography(
        ...
        EuphonyThemePreset.SOLAR -> baseTypography(
            family = FontFamily.Default,
            bodySize = 16,
            headingWeight = FontWeight.Black,
            letterSpacing = 0.25f
        )
    }
}