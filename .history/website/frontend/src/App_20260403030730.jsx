  ...
  return (
    <>
      ...
      <div className="relative overflow-hidden pb-20">
        ...
        <div className="aurora-orb -top-28 left-[8%] -z-10 h-60 w-60 bg-cyanGlow sm:h-72 sm:w-72" />
        <div className="aurora-orb right-[4%] top-[24%] -z-10 h-52 w-52 bg-accent-500 sm:h-64 sm:w-64" style={{ animationDelay: "-5s" }} />
        <div className="aurora-orb -bottom-12 left-[42%] -z-10 h-48 w-48 bg-emerald-400 sm:h-64 sm:w-64" style={{ animationDelay: "-9s" }} />
        ...
        <header className="section-shell grid gap-8 pt-16 sm:pt-20 md:grid-cols-[1.05fr_0.95fr] md:items-center md:pt-28">
          <motion.div
            ...
            className="glass-panel modern-surface rounded-3xl p-5 sm:p-8 md:p-10"
          >
            <p className="mb-4 inline-flex rounded-full border border-accent-400/40 bg-accent-500/10 px-3 py-1.5 text-[10px] font-semibold uppercase tracking-[0.18em] text-accent-300 sm:px-4 sm:py-2 sm:text-xs sm:tracking-[0.25em] float-in">
            ...
            <div className="mt-7 grid grid-cols-3 gap-2 sm:max-w-lg sm:gap-3">
              <div className="rounded-xl border border-white/15 bg-white/5 px-3 py-2">
                ...
                <p className="mt-1 text-sm font-semibold text-white">Android</p>
              </div>
              <div className="rounded-xl border border-white/15 bg-white/5 px-3 py-2">
                <p className="text-[10px] uppercase tracking-[0.2em] text-slate-400">Latest</p>
                <p className="mt-1 text-sm font-semibold text-white">{latestApk?.version || "v1.1"}</p>
              </div>
              <div className="rounded-xl border border-white/15 bg-white/5 px-3 py-2">
                <p className="text-[10px] uppercase tracking-[0.2em] text-slate-400">Status</p>
                <p className="mt-1 text-sm font-semibold text-emerald-300">Live Build</p>
              </div>
            </div>
            ...
            <div className="mt-8 flex flex-wrap gap-3 sm:mt-10 sm:gap-4">
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="btn-shimmer inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-accent-500 px-6 py-3 font-bold text-white shadow-glow transition hover:bg-accent-400 sm:w-auto"
              >
                <Download size={18} />
                Download APK
              </motion.a>
        ...
        <main className="mt-16 space-y-16 sm:mt-20 sm:space-y-20 md:mt-24 md:space-y-24">
          <motion.section id="features" className="section-shell" {...sectionReveal}>
            <SectionTitle
          ...
          <motion.section id="screenshots" className="section-shell" {...sectionReveal}>
            <SectionTitle
              eyebrow="Interface"
          ...
          <motion.section id="reviews" className="section-shell" {...sectionReveal}>
            <SectionTitle
              eyebrow="Community"
            ...
            <div className="mt-8 grid gap-8 lg:grid-cols-[1.3fr_0.7fr]">
              ...
              <form className="glass-panel modern-surface p-6" onSubmit={handleReviewSubmit}>
          ...
          <motion.section id="download" className="section-shell" {...sectionReveal}>
            <SectionTitle
              eyebrow="Releases"
          ...
          <motion.section id="about" className="section-shell" {...sectionReveal}>
            <SectionTitle
              eyebrow="About"
            ...
            />
            <div className="glass-panel modern-surface mt-8 grid gap-5 p-5 sm:p-6 md:grid-cols-3 md:p-8">
              <div>
          ...
          <motion.section id="contact" className="section-shell" {...sectionReveal}>
            <SectionTitle
              eyebrow="Contact"
            ...
            <form className="glass-panel modern-surface mt-8 p-5 sm:p-6 md:p-8" onSubmit={handleMessageSubmit}>
              <div className="grid gap-4 md:grid-cols-2">
                <input
                  required
