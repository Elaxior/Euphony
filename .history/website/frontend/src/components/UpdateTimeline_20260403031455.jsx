...
export default function UpdateTimeline({ entries }) {
  return (
    <div className="glass-panel modern-surface p-4 sm:p-6">
      ...
      <div className="mt-4 space-y-4 sm:mt-5 sm:space-y-5">
        {entries.map((entry, index) => (
          ...
          >
            ...
            <span className="absolute left-0 top-2 h-4 w-4 rounded-full border border-accent-200/60 bg-accent-500/40 shadow-[0_0_14px_rgba(124,92,255,0.55)]" />
