          ...
          <section id="about" className="section-shell">
            ...
            <div className="glass-panel mt-8 grid gap-5 p-5 sm:p-6 md:grid-cols-3 md:p-8">
              <div>
                ...
                <p className="mt-1 text-lg font-semibold">Elaxior</p>
                <a
                  href="https://github.com/Elaxior"
                  target="_blank"
                  rel="noreferrer"
                  className="mt-1 inline-block text-sm font-medium text-cyan-300 transition hover:text-cyan-200"
                >
                  github.com/Elaxior
                </a>
              </div>
